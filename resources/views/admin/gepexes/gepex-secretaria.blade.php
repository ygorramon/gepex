        ...
        <div class="box">
            ...
            <div class="row content">
                <div class="col-sm-12 ">
                    ...
                    <div class="col-sm-3">
                        <a href="{{ route('gepex-secretaria-create', $secretary->id) }}" class="btn btn-primary"> <i class="fa fa-user-plus"></i>&ensp;Adicionar GEPEX </a>
                    </div>
                    <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                        <thead>
                            <tr role="row">
                                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="city: activate to sort column ascending">
                                    GEPEXS</th>
                                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="city: activate to sort column ascending">
                                    Necessidade</th>
                                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="city: activate to sort column ascending">
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td> <span class="badge {{ setStatus($gepex->status)->color }}">{{ setStatus($gepex->status)->value }}</span>
                                    <br>
                                ...
                                <td>
                                    <form action="{{route('gepex-iniciar-execucao', $gepex->id)}}" method="post">
                                        {!! csrf_field() !!}
                                        <button class="btn btn-primary"> Iniciar Execução</button>
                                    </form>
                                </td>
                                @endif
                                @if ($gepex->status == 'EM EXECUÇÃO')
                                <td>

                                    <a href="{{ route('gepex-ver-etapas', $gepex->id) }}" class="btn btn-info">
                                        <span class="glyphicon glyphicon-hand-up"></span> Ver Etapas</a>
                                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal{{$gepex->id}}">
                                        VISUALIZAR TIMELINE
                                    </button>
                                </td>
                                @endif
                            </tr>
                            <div class="modal fade" id="modal{{$gepex->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">

                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLongTitle">GEPEX - {{$gepex->uid}} </h5>
                                            ...
                                            <div class="timeline">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="timeline-item">
                                                        ...
                                                        <div class="timeline-body">
                                                            ...
                                                            <b>Concluído em: </b> {{setDate($step->pivot->completion_date)}}
                                                            <br>
                                                            @endif
                                                ...
                                                <div>
                                                    ...
                                                    <div class="timeline-item">
                                                        ...
                                                        @if(isset($step->pivot->completion_date))
                                                        <div class="timeline-body">
                                                            <b>Última Atualização em: </b> {{setDate($step->pivot->completion_date)}}
                                                            <br>
                                                            @endif
                                                            @if(isset($step->pivot->obs))
                                                            <b>Observações: </b>{{$step->pivot->obs}}
