                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <div class="progress-group">
                                        <span class="float-right"><b>{{count($gepex->steps->where('pivot.finished',1))}}</b>/{{count($gepex->steps)}}</span>
                                        <div class="progress progress-sm">
                                            <div class="progress-bar bg-primary" style="width: {{(count($gepex->steps->where('pivot.finished',1))/count($gepex->steps))*100}}%;"></div>
                                        </div>
                                        {{(count($gepex->steps->where('pivot.finished',1))/count($gepex->steps))*100}}%
                                ...
                                <td>
                                    <form action="{{ route('gepex-enviar-aprovacao', $gepex->id) }}" method="post" class="form-group">
                                        {!! csrf_field() !!}
